...
public class FAQTest extends BaseTest {
    ...
    public static Object[][] getFaqData() {
        return new Object[][]{
                ...
                {
                        2,
                        "Допустим, вы оформляете заказ на 8 мая. Мы привезём самокат 8 мая в течение дня. Отсчёт срока аренды начинается с момента передачи самоката курьером."
                },
                {
                        3,
                ...
                {
                        5,
                        "Самокат приезжает к вам с полной зарядкой. Этого хватает на 2–3 дня."
                },
                {
                        6,
    ...
    public void checkFaqAnswerText() {
        ...
        mainPage.openFaqQuestion(questionIndex);
